...
var f_1 = new rm.FuncDep(a, b);
var f_2 = new rm.FuncDep(b, bc);
var f_3 = new rm.FuncDep(d, g);
var f_4 = new rm.FuncDep(g, i);
...
var Tests = (() => function () {
    function run() {
        ...
        var hi = new rm.AttributeSet(h, i);
        var efghi = ef.addAttri(hi);
        var f_1 = new rm.FuncDep(ab, d);
        var f_2 = new rm.FuncDep(dc, be);
        var f_3 = new rm.FuncDep(d, g);
